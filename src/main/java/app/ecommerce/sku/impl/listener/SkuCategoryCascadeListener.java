 ...
 *
 * <p>Runs synchronously inside the category deactivation transaction, alongside the product
 * cascade; both filter by the event's id, so ordering between them does not matter.
 */
@Slf4j
@Component
...
public class SkuCategoryCascadeListener {
    ...
    public void onCategoryDeactivated(final CategoryDeactivatedEvent event) {
        ...
        log.info(
            ...
            event.categoryId(), deactivatedSkus);
    }
}
